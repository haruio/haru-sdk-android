...
public class Crop {
    ...
    public static void pickImage(Activity activity) {
        ...
        try{
            ...
            Toast.makeText(activity, R.string.haru_crop_pick_error, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public Crop focusCircle() {
        cropIntent.putExtra(Extra.CIRCLE_FOCUS, true);
        return this;
    }
    ...
    static interface Extra {
        ...
        String MAX_Y = "max_y";
        String ERROR = "error";
        String CIRCLE_FOCUS = "isCircleFocus";
    }
