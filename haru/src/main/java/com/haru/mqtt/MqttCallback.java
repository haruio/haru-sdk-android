 ...
 * can be registered on both types of client: {@link IMqttClient#setCallback(com.haru.mqtt.MqttCallback)}
 * and {@link IMqttAsyncClient#setCallback(com.haru.mqtt.MqttCallback)}
 */
