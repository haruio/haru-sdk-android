...
public class PushService {
    ...
    public static void getPushTokens(final PushTokensHttpResponseHandler<PushTokenInfo[]> responseHandler) {
        ...
        APIHttpRequestTask.addTokenHeader(requestBuilder);
        APIHttpRequestTask.checkSessionAndExecute(new APIHttpRequestTask<PushTokenInfo[]>(requestBuilder.build(), responseHandler, PushTokenInfo[].class), responseHandler);
    }
