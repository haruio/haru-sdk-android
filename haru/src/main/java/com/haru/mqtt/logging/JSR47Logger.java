 ...
 * {@link com.haru.mqtt.util.Debug Debug} provides method to make it easy
...
public class JSR47Logger implements Logger {
	 ...
	 * @param loggerID			The suffix for the loggerName (will be appeneded to com.haru.mqtt
...
//		loggerName = "com.haru.mqtt." + ((null == loggerID || 0 == loggerID.length()) ? "internal" : loggerID);
		loggerName = loggerID;
